...
protocol RepositoryProtocol {
    func getImages(category: String, page: Int) async throws -> [ImageModel]
}
...
class Repository: RepositoryProtocol {
    ...
    func getImages(category: String, page: Int) async throws -> [ImageModel] {
        ...
        let data = try await API.sendRequestData(request: Requests.getImages(category: category, page: page))
